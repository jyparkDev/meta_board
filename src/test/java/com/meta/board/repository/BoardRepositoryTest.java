...
class BoardRepositoryTest {
    ...
    @Test
    void 게시글_등록(){
        boardRepositoryImpl.save(BoardBean.builder().title("a").content("A").writer("test").passwd("aaa").build());
    ...
    void 게시글_수정(){
        boardRepositoryImpl.save(BoardBean.builder().title("a").content("A").writer("test").passwd("aaa").build());
        BoardBean updateBoard = BoardBean.builder().title("aa").content("A").build();
